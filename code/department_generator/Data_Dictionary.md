...
This file describes all variables in `data/departments_dataset.csv`, the primary input dataset containing 101 U.S. statistics departments used in the simulation. It also describes the two supporting data files used to construct the department dataset.
